...
def read_data(fold_num, folder, subject_ID):
    ...
    Channel_list = np.array([93, 94, 95, 96, 148, 167, 166, 165, 113, 112,
                             111, 130, 164, 182, 183, 184])  # Ear-EEG对应通道
    ...
    train_data = train_data[:, :, Channel_list, :]
    validation_data = validation_data[:, :, Channel_list, :]
    test_data = test_data[:, :, Channel_list, :]
